...
class cogito_post_grid extends Widget_Base {
    ...
    public function get_name() {
        return 'cogito-post-grid';
    }

    public function get_title() {
        return esc_html__( 'Posts Grid', 'cogito' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new cogito_post_grid );